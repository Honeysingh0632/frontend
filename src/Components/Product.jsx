...
const Product = () => {
    const [img,Setimg]= useState(require('../Components/images/main.jpeg'));
    const [imgsm,Setimgsm]= useState(require('../Components/images/small.jpeg'));
    const [imgsm1,Setimgsm1]= useState(require('../Components/images/small2.jpeg'));
    const [imgsm2,Setimgsm2]= useState(require('../Components/images/small3.jpeg'));
    ...
    const img1= ()=> {
         ...
         let img1 =(require('../Components/images/small.jpeg'))
    ...
    const img2= ()=> {
        ...
        Setimg(require('../Components/images/small2.jpeg'))
    }
    const img3= ()=> {

        Setimg(require('../Components/images/small3.jpeg'))
    }
    const img4= ()=> {

        Setimg(require('../Components/images/main.jpeg'))
    }
    
    const addtocart = () => {
      let  value=('Nike Airforce 1 Orange white')
      let price = ('152.49')

      let set =(prevText) => [...prevText, `${value} ${Count} ${hi}`]
       ...
       <div className="container">
        <div className="row">
            ...
            <div className="col-lg-6">
                ...
                <button className="btn btn-primary me-2 mt-3" onClick={addtocart}>Add to cart</button>
                <button className="btn btn-primary mt-3">Add to Wishlist</button>
            </div>

         
            <div>
        {product.map((block, index) => (
          <div key={index} style={{ margin: '5px 0', padding: '10px', border: '1px solid black' }}>
