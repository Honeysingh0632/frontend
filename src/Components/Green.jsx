...
const Green = () => {
    const [img,Setimg]= useState(require('../Components/images/green.jpeg'));
    const [imgsm,Setimgsm]= useState(require('../Components/images/green1.jpeg'));
    const [imgsm1,Setimgsm1]= useState(require('../Components/images/green2.jpeg'));
    const [imgsm2,Setimgsm2]= useState(require('../Components/images/green3.jpeg'));
    ...
    const img1= ()=> {
         ...
         let img1 =(require('../Components/images/green.jpeg'))
    ...
    const img2= ()=> {
        ...
        Setimg(require('../Components/images/green1.jpeg'))
    }
    const img3= ()=> {

        Setimg(require('../Components/images/green2.jpeg'))
    }
    const img4= ()=> {

        Setimg(require('../Components/images/green3.jpeg'))
    }
