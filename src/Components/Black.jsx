...
const Black = () => {
    const [img,Setimg]= useState(require('../Components/images/black.jpeg'));
    const [imgsm,Setimgsm]= useState(require('../Components/images/black1.jpeg'));
    const [imgsm1,Setimgsm1]= useState(require('../Components/images/black2.jpeg'));
    const [imgsm2,Setimgsm2]= useState(require('../Components/images/black3.jpeg')) ;
